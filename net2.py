...
class My_RCF(nn.Module):
    def __init__(self):
        super(My_RCF, self).__init__()
        # lr 1 2 decay 1 0
    ...
    def forward(self, x):
        ...
        conv3_4 = self.relu(self.conv3_3(conv3_3))
        pool3 = self.maxpool(conv3_4)

        conv4_1 = self.relu(self.conv4_1(pool3))
        conv4_2 = self.relu(self.conv4_2(conv4_1))
        conv4_3 = self.relu(self.conv4_3(conv4_2))
        conv4_4 = self.relu(self.conv4_3(conv4_3))
        pool4 = self.maxpool4(conv4_4)

        conv5_1 = self.relu(self.conv5_1(pool4))
        conv5_2 = self.relu(self.conv5_2(conv5_1))
        conv5_3 = self.relu(self.conv5_3(conv5_2))
        conv5_4 = self.relu(self.conv5_3(conv5_3))
        ...
        so3_out = self.score_dsn3(conv3_1_down + conv3_2_down + conv3_3_down + conv3_4_down)
        so4_out = self.score_dsn4(conv4_1_down + conv4_2_down + conv4_3_down + conv4_4_down)
        so5_out = self.score_dsn5(conv5_1_down + conv5_2_down + conv5_3_down + conv5_4_down)
